...
dss.Text.Command("Compile Master_Base.dss")
...
# ============================================================
# 3) CONFIGURA SIMULAÇÃO TIME-SERIES
# ============================================================
...
# ============================================================
# 4) CRIA ARRAYS PARA ARMAZENAR RESULTADOS
# ============================================================
...
for h in range(n_horas):
    ...
    # Potência total do sistema (subestação)
